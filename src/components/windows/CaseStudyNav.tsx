...
export function CaseStudyNav() {
  ...
  return (
    <div
      ...
      className="pointer-events-none fixed top-1/2 z-50 hidden w-[62.5px] animate-[nav-in-right_320ms_var(--ease-out)_forwards] flex-col items-center gap-2 rounded-full border border-border bg-white p-2 shadow-lg shadow-black/5 xl:flex"
    >
      <button
        type="button"
